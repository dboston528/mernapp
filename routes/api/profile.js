...
router.post(
  ...
  async (req, res) => {
    ...
    if (location) profileFields.loacation = location;
...
// @route   PUT request to api/profile/experience
...
// @desc    Delete experirence from profile
// @access  Private
...
// @route   PUT request to api/profile/education
